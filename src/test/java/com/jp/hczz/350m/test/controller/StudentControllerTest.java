package com.jp.hczz.350m.test.controller;
...
public class StudentControllerTest extends TestCase{
	...
	public void testStudentController() throws Exception{
		...
		mockMvc.perform(MockMvcRequestBuilders.get(new URI("/students/"+id)))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.name").value("赵旭阳"));
	}
}